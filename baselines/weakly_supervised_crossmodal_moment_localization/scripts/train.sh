...
# Usage:
# bash baselines/weakly_supervised_crossmodal_moment_localization/scripts/train.sh tvr all ANY_OTHER_PYTHON_ARGS
...
results_root=baselines/weakly_supervised_crossmodal_moment_localization/results
vid_feat_size=2048
extra_args=()
...
python baselines/weakly_supervised_crossmodal_moment_localization/train.py \
--dset_name=${dset_name} \
